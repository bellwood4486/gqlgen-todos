...
type UserLoaderConfig struct {
	...
	Fetch func(keys []int32) ([]*model.User, []error)
...
func (l *UserLoader) Load(key int32) (*model.User, error) {
...
func (l *UserLoader) LoadThunk(key int32) func() (*model.User, error) {
	l.mu.Lock()
...
func (l *UserLoader) LoadAll(keys []int32) ([]*model.User, []error) {
...
// This method should be used if you want one goroutine to make requests to many
// different data loaders without blocking until the thunk is called.
func (l *UserLoader) LoadAllThunk(keys []int32) func() ([]*model.User, []error) {
	results := make([]func() (*model.User, error), len(keys))
	for i, key := range keys {
		results[i] = l.LoadThunk(key)
	}
...
func (l *UserLoader) Prime(key int32, value *model.User) bool {
	l.mu.Lock()
	var found bool
...
func (l *UserLoader) unsafeSet(key int32, value *model.User) {
	if l.cache == nil {
		l.cache = map[int32]*model.User{}
	}
	l.cache[key] = value
}
